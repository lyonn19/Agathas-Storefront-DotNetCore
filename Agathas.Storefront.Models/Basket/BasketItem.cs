...
namespace Agathas.Storefront.Model.Basket {
    ...
    public decimal LineTotal() { return Product.Price * Qty; }
    ...
    public bool Contains(Product product) { return Product == product; }

    public void IncreaseItemQtyBy(int qty) { _qty += qty;  }

    public void ChangeItemQtyTo(int qty) {  _qty = qty; }
